var StarClouds = pc.createScript('StarClouds');

var t = new pc.Color(0.49,0.6,1.0),
    e = new pc.Color(1.0,0.7,0.37);


StarClouds.attributes.add('starmap', { type: 'asset' });
StarClouds.attributes.add('hazemap', { type: 'asset' });
StarClouds.attributes.add('flaremap', { type: 'asset' });
StarClouds.attributes.add('scale',{type:'number'});

// initialize code called once per entity
StarClouds.prototype.initialize = function() {
    var self = this;
...
StarClouds.prototype.update = function(dt) {
    
};

StarClouds.prototype.InitStarsData = function() {
...
StarClouds.prototype.InitMaterial = function() {
...
StarClouds.prototype.buildGeometry = function() {
    var app = this.app;
    ...
    this.buildPointSphereGeometry(this.hazeGeometry, 1600, this.clouds[2].radius, this.clouds[2].height, this.clouds[2].color);
...
StarClouds.prototype.buildPointSpiralGeometry = function(e, t, r, i, o, a, s, u) {
    for (var c = 0; r > c; c++)
...
StarClouds.prototype.buildPointSphereGeometry = function(e, t, r, i, o) {
    for (var a = 0; t > a; a++) {
        var s = new pc.Vec3(),
            u = Math.random() * r,
...
StarClouds.prototype.getStarColor = function(r) {
...
StarClouds.prototype.updateBlast = function () {
